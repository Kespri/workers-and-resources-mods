...
setlocal
chcp 65001 >nul
title Republic Mod Manager - Installation
echo.
echo Republic Mod Manager - Installation / Install
echo ===============================================
echo.
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Install-RMM.ps1" %*
set RC=%ERRORLEVEL%
echo.
if not "%RC%"=="0" (
    echo ------------------------------------------------------------------
