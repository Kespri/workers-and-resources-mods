...
Das Plugin enthält keinen fremden Code. Der Quellcode liegt im TesmioLoader-Quellbaum unter `my_plugins\technical_service_storage`, nicht in diesem Paket. Der Service-Header `grit_spreader_api.h` verbindet es mit Weather Roads.
